...
**TweetClient** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
- [X] Changes UI Elements in the Compose Tweet page to match the current dark Twitter aesthetic
...
-Figuring out how to add an character count counter
